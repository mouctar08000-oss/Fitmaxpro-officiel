...
abs_workouts = [
    ...
    # English - Beginner
    {
        "workout_id": "workout_abs_beginner_en_01",
    ...
    {
        "workout_id": "workout_abs_intermediate_en_01",
    ...
    # English - Advanced
    {
        "workout_id": "workout_abs_advanced_en_01",
...
async def create_abs_workouts():
    print("=" * 60)
    print("SEEDING ABS WORKOUTS (UPSERT STRATEGY)")
    print("=" * 60)
    ...
    print("SUMMARY")
    print("=" * 60)
    print(f"  Total processed: {len(abs_workouts)}")
