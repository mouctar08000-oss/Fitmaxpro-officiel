      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          {Object.keys(socialLinks).filter(k => socialLinks[k]).length > 0 && (
            <div className="bg-gradient-to-br from-[#1a1a2e] to-[#121212] border border-[#27272a] rounded-xl p-6 mb-12 relative overflow-hidden">
              {/* Background decoration */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-red-500/10 to-purple-500/10 rounded-full blur-3xl"></div>
              
              <h3 className="text-2xl font-bold mb-2 flex items-center gap-2 relative" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
                <span className="text-3xl">📱</span>
                {isFr ? 'SUIVEZ-NOUS' : 'FOLLOW US'}
              </h3>
              <p className="text-gray-400 text-sm mb-6 relative">
                {isFr ? 'Rejoignez la communauté FitMaxPro sur les réseaux sociaux pour du contenu exclusif !' : 'Join the FitMaxPro community on social media for exclusive content!'}
              </p>
              <div className="flex flex-wrap gap-4 relative">
                {socialLinks.instagram && (
                  <a 
                    ...
                    className="flex items-center gap-3 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-500 px-5 py-3 rounded-xl hover:scale-105 hover:shadow-lg hover:shadow-pink-500/30 transition-all duration-300"
                  >
                    <Instagram className="w-6 h-6" />
                    <div>
                      <span className="font-bold block">Instagram</span>
                      <span className="text-xs opacity-80">@fitmaxpro</span>
                    </div>
                  </a>
                )}
                {socialLinks.youtube && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 bg-red-600 px-5 py-3 rounded-xl hover:scale-105 hover:shadow-lg hover:shadow-red-500/30 transition-all duration-300"
                  >
                    <Youtube className="w-6 h-6" />
                    <div>
                      <span className="font-bold block">YouTube</span>
                      <span className="text-xs opacity-80">{isFr ? 'Vidéos & Tutoriels' : 'Videos & Tutorials'}</span>
                    </div>
                  </a>
                )}
                {socialLinks.tiktok && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 bg-gradient-to-r from-cyan-400 to-pink-500 px-5 py-3 rounded-xl hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/30 transition-all duration-300"
                  >
                    <TikTokIcon />
                    <div>
                      <span className="font-bold block">TikTok</span>
                      <span className="text-xs opacity-80">{isFr ? 'Contenus courts' : 'Short content'}</span>
                    </div>
                  </a>
                )}
                {socialLinks.facebook && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 bg-blue-600 px-5 py-3 rounded-xl hover:scale-105 hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300"
                  >
                    ...
                    <div>
                      ...
                      <span className="text-xs opacity-80">{isFr ? 'Communauté' : 'Community'}</span>
                    </div>
                  </a>
                )}
                {socialLinks.snapchat && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 bg-yellow-400 text-black px-5 py-3 rounded-xl hover:scale-105 hover:shadow-lg hover:shadow-yellow-500/30 transition-all duration-300"
                  >
                    <span className="text-2xl">👻</span>
                    <div>
                      <span className="font-bold block">Snapchat</span>
                      <span className="text-xs opacity-80">{isFr ? 'Stories exclusives' : 'Exclusive stories'}</span>
                    </div>
                  </a>
                )}
                {socialLinks.twitter && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 bg-black border border-white/20 px-5 py-3 rounded-xl hover:scale-105 hover:shadow-lg hover:shadow-white/10 transition-all duration-300"
                  >
                    <span className="font-bold text-xl">𝕏</span>
                    <div>
                      <span className="font-bold block">X (Twitter)</span>
                      <span className="text-xs opacity-80">{isFr ? 'Actualités' : 'News'}</span>
                    </div>
                  </a>
                )}
                {socialLinks.whatsapp && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 bg-green-500 px-5 py-3 rounded-xl hover:scale-105 hover:shadow-lg hover:shadow-green-500/30 transition-all duration-300"
                  >
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                    ...
                    <div>
                      ...
                      <span className="text-xs opacity-80">{isFr ? 'Contact direct' : 'Direct contact'}</span>
                    </div>
                  </a>
                )}
                {socialLinks.telegram && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 bg-blue-500 px-5 py-3 rounded-xl hover:scale-105 hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300"
                  >
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                    ...
                    <div>
                      ...
                      <span className="text-xs opacity-80">{isFr ? 'Groupe privé' : 'Private group'}</span>
                    </div>
                  </a>
                )}
                {socialLinks.website && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-3 bg-gradient-to-r from-gray-700 to-gray-600 px-5 py-3 rounded-xl hover:scale-105 hover:shadow-lg transition-all duration-300"
                  >
                    <span className="text-2xl">🌐</span>
                    <div>
                      <span className="font-bold block">{isFr ? 'Site Web' : 'Website'}</span>
                      <span className="text-xs opacity-80">{isFr ? 'Plus d\'infos' : 'More info'}</span>
                    </div>
                  </a>
                )}
              </div>
